...
export const PRESET_BACKGROUNDS: Background[] = [
  {
    ...
    startScene:
      '你叫曦宇，大一上学期，普通的一天。\n\n刚才在教学楼三楼一路狂奔——那杯不该续杯的冰美式终于在你撑不住的瞬间逼你冲进最近一道厕所门，根本没顾得上看门牌。隔间里你正畅快地解决问题，墙上的瓷砖凉得发亮。\n\n然后你听见走廊里传来轻快的脚步声和说话声——是几个女生的声音。声音越来越近，停在了你这间隔间的门外。\n\n一个女声压低了下来：「这间锁着……不会是有人占着不出来吧？」「等会儿再问问？」\n\n你僵在原地，连呼吸都不敢用力。你低头看了看自己的运动裤——男生的板鞋——男生的、毫无疑问是男生的一切。然后你抬头看了眼隔间门牌：粉色，画着一个穿裙子的小人。\n\n你走错厕所了。\n\n外面的脚步又近了一步，那个声音已经在叫保洁阿姨。一种灭顶的、社死级的恐惧从脚底窜上头皮——你这辈子第一次想要某种神迹，任何神迹，来救救你。',
  },
];
