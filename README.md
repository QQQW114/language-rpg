...
在26年高考完成前后，不进行更新维护，当前执笔模式新做的的提示词和模型配置改动明显不够完善，游历模式也没有跟进更新，bug多且功能有问题，但暂时无心力投入
...
--后续将考虑拆分与重构，当前版本模型不合理，后续将整合模型功能，每轮调用模型种类数控制到2个模型，提高单个模型工具与能力，移除当前这套极度不合理的“模型分析问题以确定复杂分析的必要性” 
-
